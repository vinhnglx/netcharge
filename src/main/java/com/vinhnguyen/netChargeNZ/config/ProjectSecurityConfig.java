...
public class ProjectSecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .requestMatchers(HttpMethod.POST, "/api/connectors").hasAuthority("ADMIN")
            .requestMatchers(HttpMethod.GET, "/api/chargingSessions").hasAuthority("ADMIN")
            .requestMatchers(HttpMethod.GET, "/api/chargePoints").hasAuthority("CUSTOMER")
            .requestMatchers(HttpMethod.POST, "/api/chargingSessions").hasAuthority("CUSTOMER")
            .requestMatchers(HttpMethod.PUT, "/api/chargingSessions/{sessionId}/end").hasAuthority("CUSTOMER")
